...
{/* openEvent={openGallery} */}
        <SwiperSlide> <Card cardImage={snackwiseImage} title="Snackwise" description="Web-based online ordering system for SnackWise" stack={snackwiseStack} webLink="#" githubLink="#" images={aralinkImages} setItems={setItems}/></SwiperSlide>
        <SwiperSlide> <Card cardImage={aralinkImage} title="Aralink" description="A website where you can compile the video recordings of your classes through embed links" stack={aralinkStack} webLink="#" githubLink="#"/></SwiperSlide>
        <SwiperSlide> <Card cardImage={apexLegendsMapRotationImage} title="Apex Legens Map Tracker" description="Apex Legends map rotation tracker" stack={apexMapTrackerStack} webLink="#" githubLink="#"/></SwiperSlide>
        <SwiperSlide> <Card cardImage={resistorCalculatorImage} title="Resistor Calculator" description="Tool for reading resistor color code values for a 4 band resistor, 5 band resistor, or 6 band resistor" stack={resistorCalculatorStack} webLink="https://darwannn.github.io/resistor-calculator/" githubLink="#"/></SwiperSlide>
        <SwiperSlide> <Card cardImage={pasahelpImage} title="Pasahelp" description="Mega Manila Jeepney Fare Calculator" stack={pasahelpStack} webLink="https://darwannn.github.io/pasahelp/" githubLink="#"/></SwiperSlide>
        <SwiperSlide> <Card cardImage={slvisualsImage} title="SL Visuals" description="Portfolio of Architect Christian San Luis" stack={slvisualsStack} webLink="#" githubLink="#"/></SwiperSlide>
        <SwiperSlide> <Card cardImage={noImage} title="My Portfolio" description="My Portfolio" stack={portfolioStack} webLink="#" githubLink="#"/></SwiperSlide>
