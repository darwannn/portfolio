    ...
    <div className="w-full m-0  xl:w-3/4 lg:-ml-24 lg:-mt-24 xl:-ml-24 xl:-mt-24">
      ...
      <div className="flex flex-col-reverse lg:flex-row xl:flex-row relative z-50">
        ...
        <div className="flex-1 lg:ml-8 xl:ml-8">
          ...
          <div className="mt-2 mb-4 text-2xl">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris ornare mollis tellus, eget feugiat nulla cursus sit amet. Quisque ut tellus in velit finibus malesuada tempus a lacus.</div>
          <a href="#" target="_blank" className="btn rounded-md px-10 py-2 w-40 button-blue">RESUME</a>
        </div>
      </div>
    </div>
  </div>
