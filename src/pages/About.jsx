...
function About({ standalone }) {
  return (
    <>
      <div id="about">
        <Banner
          text={"About"}
          image={standalone ? "" : meImage}
          position="50% 60%"
          scrollStart={0}
        />
        ...
        <div className="flex justify-center relative  -mt-16 z-50">
          <div className="w-full mb-10 mx-10 p-10 md:p-20 bg-white box-shadow rounded-2xl">
            ...
            <div className="md:ml-10">
              ...
              using vanilla JS and PHP, Java Swing desktop application, Android
              ...
              most. And I am currently learning React, Tailwind, Express, and
              MongoDB to further enhance my skills.
            </div>
            ...
            <div className="flex flex-wrap gap-3  justify-center  mt-10 ">
              <img
                src={bootstrapIcon}
                alt=""
                className="h-20 hover:-translate-y-1 transition-all duration-200"
              />
              <img
                src={tailwindIcon}
                alt=""
